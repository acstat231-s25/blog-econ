...
ggplot(data1 |> filter(`Indicator Name` == 
      "Renewable electricity output (% of total electricity output)"),
      aes(x = period, y = value, color = region_un)) +
    geom_line() +
    geom_point() +
    labs(
      title = paste("Renewable electricity output output"),
      subtitle = "Median values per year",
      x = "Year",
...
ggplot(data1 |> filter(`Indicator Name` == 
    ...
    geom_point() +
    labs(
      title = paste("Renewable energy consumption"),
      subtitle = "Median values per year",
      x = "Year",
...
ggplot(data1 |> filter(`Indicator Name` == 
    ...
    geom_point() +
    labs(
      title = paste("Electricity production from coal sources (% of total)"),
      subtitle = "Median values per year",
      x = "Year",
      y = "% of total",
      color = "Region"
