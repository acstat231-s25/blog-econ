...
pacman::p_load(viridis, tidyverse, ggplot2, lubridate, knitr, dplyr, purrr, 
               ...
               GGally, tidyr, kableExtra, shinylive)
...
data1 <- data |>
    filter(`Indicator Name` ==  c("Electricity production from coal sources (% of total)", "Electricity production from oil sources (% of total)")) |>
    select(region_un, `Indicator Name`, starts_with(c("19", "20")), ends_with("_median")) |>
    pivot_longer(
      cols = starts_with(c("19", "20")) & ends_with("_median"),
      names_to = "period",
      values_to = "value"
...
After the process of standardizing indicators and k-means clustering for the years 1990 and 2015 was complete, the table we created allowed us to take a glimpse at the changes in cluster group assignments for the first 10 countries and regions in this newly formed dataset. At first glance, you can see the region of 'Africa Eastern and Southern' changed groups from 4 to 3, while the country of Argentina moved from 4 to 3.
