...
author: 
  - "Eglah Belizor"
  - "Shamil Khusnullin"
  - "Mariia Koval (main contributor)"
abstract: "We analyze global trends in sustainability from 1990 to 2022 in terms of CO₂ emissions, renewables usage, deforestation, and fossil fuel usage. Through visualization, clustering, supervised machine learning, we uncover clusters of nations by sustainability levels and how they shift over time. Europe and North America reduced emissions, while Southeast Asia grew tremendously. Growth in renewable energy and a reduction in fossil fuel usage were strong predictors of enhanced sustainability."
...
#| fig-align: center
#| out-width: 100%
knitr::include_graphics("images/pic2.jpg")
```
