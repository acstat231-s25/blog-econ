...
# Prepare renewable electricity dataframe
 data1 <- data |>
  ...
  # Select continent medians only, as they will be plotted
...
# Plot forest area trends by filtering indicator of interest
p <- ggplot(data1 |> 
...
# Plot renewable electricity consumption
p2 <- ggplot(data1 |> 
              filter(`Indicator Name` == 
              "Renewable energy consumption (% of total final energy consumption)"), 
                       aes(x = period, y = value, color = region_un,
...
# Plot electricity production from oil sources
p3 <- ggplot(data1 |> 
              filter(`Indicator Name` == 
              "Electricity production from oil sources (% of total)"), 
                       aes(x = period, y = value, color = region_un,
...
# Plot electricity production from coal sources
p4 <- ggplot(data1 |> 
              filter(`Indicator Name` == 
              "Electricity production from coal sources (% of total)"), 
                       aes(x = period, y = value, color = region_un,
